...
#    print ("ya ",ya)
    ...
    sp_image_crop_top=814
    sp_image_crop_bottom=-926
    sp_image_crop_left=784
    sp_image_crop_right=-2616
...
#    ax8.add_feature(state_boundaries, linestyle=':')
    ...
    plt.close(fig15)
    print("done saving gtlakes")

#    fig16 = plt.figure(figsize=(18.,10.73))
    fig16 = plt.figure(figsize=(20.,15.75))
    ax16 = fig16.add_subplot(1, 1, 1, projection=proj)
    ax16.outline_patch.set_edgecolor('none')
    ax16.background_patch.set_fill(False)
    ax16.patch.set_facecolor('none')
    im = ax16.imshow(out[sp_image_crop_top:sp_image_crop_bottom,sp_image_crop_left:sp_image_crop_right],extent=(xa[sp_image_crop_left],xa[sp_image_crop_right],ya[sp_image_crop_bottom],ya[sp_image_crop_top]), origin='upper')
    ...
    text16 = ax16.text(0.50, 0.92, time_string,
        horizontalalignment='center', transform = ax16.transAxes,
        color='yellow', fontsize='large', weight='bold')
    text16.set_path_effects(outline_effect)
    oname16 = "/dustdevil/goes16/grb/rgb/sp/"+iyear+imonth+iday+itimehr+itimemn+"_sp.jpg"
    fig16.figimage(aoslogo,  0, 0, zorder=10)
    fig16.savefig(oname16, bbox_inches='tight', pad_inches=0)
    plt.close(fig16)
    print("done saving splains")
...
#    print("done saving conus")
    ...
    print("done rename wi")
    print("start rename mi")
    ...
    print("done rename mi")
    print("start rename ne")
    ...
    print("done rename ne")
    print("start rename gulf")
    ...
    print("done rename gulf")
    print("start rename conus")
    ...
    print("done rename conus")
    print("start rename sw")
    ...
    print("done rename sw")
    print("start rename nw")
    ...
    print("done rename nw")
    print("start rename gtlakes")
    ...
    print("done rename gtlakes")
    print("start rename sp")

    silentremove("/dustdevil/goes16/grb/rgb/sp/latest_sp_36.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_35.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_36.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_34.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_35.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_33.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_34.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_32.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_33.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_31.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_32.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_30.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_31.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_29.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_30.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_28.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_29.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_27.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_28.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_26.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_27.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_25.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_26.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_24.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_25.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_23.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_24.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_22.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_23.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_21.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_22.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_20.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_21.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_19.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_20.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_18.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_19.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_17.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_18.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_16.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_17.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_15.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_16.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_14.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_15.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_13.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_14.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_12.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_13.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_11.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_12.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_10.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_11.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_9.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_10.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_8.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_9.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_7.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_8.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_6.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_7.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_5.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_6.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_4.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_5.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_4.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_5.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_3.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_4.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_2.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_3.jpg")
    silentrename("/dustdevil/goes16/grb/rgb/sp/latest_sp_1.jpg", "/dustdevil/goes16/grb/rgb/sp/latest_sp_2.jpg")
    shutil.copy(oname16, "/dustdevil/goes16/grb/rgb/sp/latest_sp_1.jpg")

    print("done rename sp")
    print("start glob wi")
...
#    print("done with GULF manipulation")
    ...
    print("done glob gulf")
    print("start glob conus")
...
#    print("done with MW manipulation")
    ...
    print("done glob gtlakes")
    print("start glob sp")

    # SW 3/6h loops
    file_list = glob.glob('/dustdevil/goes16/grb/rgb/sp/2*jpg')
    file_list.sort()
    thefile = open('/dustdevil/goes16/grb/rgb/sp/sp_3h_temp.list', 'w')
    thelist = file_list[-36:]
    #print ("thelist is ",thelist)
    ...
    for item in thelist:
        ...
        thefile.write(tail + '\n')
    thefile.close
    os.rename('/dustdevil/goes16/grb/rgb/sp/sp_3h_temp.list','/dustdevil/goes16/grb/rgb/sp/sp_3h.list')
     
    thefile = open('/dustdevil/goes16/grb/rgb/sp/sp_6h_temp.list', 'w')
    thelist = file_list[-72:]
    #print ("thelist is ",thelist)
    ...
    for item in thelist:
        ...
        thefile.write(tail + '\n')
    thefile.close
    os.rename('/dustdevil/goes16/grb/rgb/sp/sp_6h_temp.list','/dustdevil/goes16/grb/rgb/sp/sp_6h.list')
