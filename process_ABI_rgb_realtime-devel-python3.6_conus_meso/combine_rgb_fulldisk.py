...
# 12h // 60 images
    thefile = open('/dustdevil/goes16/grb/rgb/namer/namer_60_temp.list', 'w')
    ...
    for item in thelist:
        ...
        thefile.write(tail + '\n')
    thefile.close
    os.rename('/dustdevil/goes16/grb/rgb/namer/namer_60_temp.list','/dustdevil/goes16/grb/rgb/namer/namer_60.list')
...
# 12h // 60 images
    thefile = open('/dustdevil/goes16/grb/rgb/fulldisk/fulldisk_60_temp.list', 'w')
    thelist = file_list[-60:]
    #print ("thelist is ",thelist)
    ...
    for item in thelist:
        ...
        thefile.write(tail + '\n')
    thefile.close
    os.rename('/dustdevil/goes16/grb/rgb/fulldisk/fulldisk_60_temp.list','/dustdevil/goes16/grb/rgb/fulldisk/fulldisk_60.list')
